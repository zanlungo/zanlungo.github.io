...
\ecvitem{2022-}{Collaborative researcher in the Advanced Mathematical Science for Mobility Society of Kyoto
University (Unit leader: Prof S. Tsujimoto)}
...
\begin{enumerate}
\item The need to include a velocity dependent potential in a collision avoiding model for pedestrians, and the development of a corresponding mathematical and computational model {\bf[15]}.
\item The improvement of the above model by taking in account the asymmetrical shape of human bodies {\bf[3]}, an analysis based on the dynamics of cross-flows {\bf[2,23]}.
\item The development of ``Congestion Number'', a mathematical tool to asses the state of a human pedestrian crowd {\bf[1,25]}, {\it (in collaboration with the Nishinari lab. of Tokyo University)}
...
and the development of a method to introduce in a realistic way such a tendency in any pedestrian collision avoidance model {\bf[14,43]}.
\item Large pedestrian groups are not stable, and usually break up in more stable 2 or 3 pedestrian sub-units {\bf[41]}.
...
large environments {\bf[12]}.   
\item Empirical study and mathematical modelling of how crowd density and other environment features affect the behaviour of pedestrians and in particular of groups {\bf[9,10,39,40]}. 
\item How group composition and social roles affect the behaviour of pedestrian groups, and how this information may be used to automatically recognise groups and their composition  {\bf[4,5,8,24,26,28,31,32,38]}. 
\item How gestures affect the behaviour of pedestrian groups {\bf[7,34]}.
\item How the presence of groups affects crowd dynamics {\bf[29]} 
\end{enumerate}
\\
}

\ecvitem{Human-Robot interaction}{\it Socially acceptable mobile robot navigation, in collaboration with T.~Kanda}
\ecvitem{}{While working at  ATR I have been also involved in more engineering oriented works, such as the development of a robot able to smoothly navigate inside a human crowd {\bf[11,27,33,35,44,46]},
and the development of algorithms to automatically detect pedestrian walking goals {\bf[42]} and pedestrian groups {\bf[13,36,45]}.
\\
}
...
analysis of the differences between the effect of random noise and the effect of numerical round-off on the dynamics of the map {\bf[16,17,18]}.\\}
\newpage
...
do not follow the action-reaction law of dynamics {\bf[20,30]}.
\end{enumerate}\\}
...
\ecvitem{\thepapercount}{F. Zanlungo, C. Feliciani, Z. Y\"ucel, X. Jia, K. Nishinari, T. Kanda}
\ecvitem{}{A pure number to assess ``congestion'' in pedestrian crowds}
\ecvitem{}{Transportation Research Part C: Emerging Technologies 148, 104041, 2023}
\ecvitem{}{https://doi.org/10.1016/j.trc.2023.104041 {\bf (2022 impact factor 9.021)}}
\ecvitem{}{}

\stepcounter{papercount}
\ecvitem{\thepapercount}{F. Zanlungo, C. Feliciani, Z. Y\"ucel, K. Nishinari, T. Kanda}
\ecvitem{}{Macroscopic and microscopic dynamics of a pedestrian cross-flow: Part II, modelling}
\ecvitem{}{Safety Science 158, 105969, 2023}
\ecvitem{}{https://doi.org/10.1016/j.ssci.2022.105969 {\bf (2022 impact factor 6.392)}}
\ecvitem{}{}

\stepcounter{papercount}
\ecvitem{\thepapercount}{F. Zanlungo, C. Feliciani, Z. Y\"ucel, K. Nishinari, T. Kanda}
\ecvitem{}{Macroscopic and microscopic dynamics of a pedestrian cross-flow: Part I, experimental analysis}
\ecvitem{}{Safety Science 158, 105953, 2023}
\ecvitem{}{https://doi.org/10.1016/j.ssci.2022.105953 {\bf (2022 impact factor 6.392)}}
\ecvitem{}{}
...
\ecvitem[10pt]{\large Conference papers}

\stepcounter{papercount}
\ecvitem{\thepapercount}{F.~Zanlungo, C.~Feliciani,H.~Murakami, Z.~Y\"ucel, X.~Jia, K.~Nishinari, T.~Kanda}
\ecvitem{} {\it Density dependence of stripe formation in a cross-flow}
\ecvitem{}{International Conference on Traffic and Granular Flow (TGF 2022)}
\ecvitem{}{15-17 October 2022, Delhi, India}

\stepcounter{papercount}
\ecvitem{\thepapercount}{A.~Gregorj, Z.~Y\"cel, F.~Zanlungo, T.~Kanda}
\ecvitem{} {\it On the influence of group social interaction on intrusive behaviors}
\ecvitem{}{International Conference on Traffic and Granular Flow (TGF 2022)}
\ecvitem{}{15-17 October 2022, Delhi, India}

\stepcounter{papercount}
\ecvitem{\thepapercount}{F.~Zanlungo, C.~Feliciani, Z.~Y\"cel, K.~Nishinari, T.~Kanda}
\ecvitem{} {\it Crowd congestion number}
\ecvitem{}{Pedestrian and Evacuation Dynamics, PED 2021}
\ecvitem{}{Dec 2021, Melbourne, Australia}

\stepcounter{papercount}
\ecvitem{\thepapercount}{A.~Gregorj, Z.~Y\"cel, F.~Zanlungo, C.~Feliciani, T.~Kanda}
\ecvitem{} {\it On the influence of group social relation on the dynamics of pedestrians outside the group}
\ecvitem{}{Pedestrian and Evacuation Dynamics, PED 2021}
\ecvitem{}{Dec 2021, Melbourne, Australia}
